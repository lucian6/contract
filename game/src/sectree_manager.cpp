...
#ifdef ENABLE_DUNGEON_BOSS_ICON_IN_MAP
void SECTREE_MANAGER::InsertNPCPosition(long lMapIndex, BYTE bType, DWORD vnum, long x, long y, DWORD time)
{
	m_mapNPCPosition[lMapIndex].push_back(npc_info(bType, vnum, x, y, time));
}
#else
