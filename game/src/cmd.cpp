...
struct command_info cmd_info[] =
{
...
#ifdef ENABLE_SHOP_SEARCH_SYSTEM
	{ "shop_search",	do_shop_search,		0,		POS_DEAD,	GM_PLAYER },
#endif
#ifdef ENABLE_WIKI
	{ "wiki_server",	do_wiki_server,		0,		POS_DEAD,	GM_PLAYER },
#endif
#ifdef ENABLE_MULTI_FARM_BLOCK
...
#endif
	{ "zodiac_treasure", do_zodiac_treasure, 0, POS_DEAD, GM_PLAYER },
#ifdef ENABLE_BIYOLOG
	{ "bio",	do_bio,		0,		POS_DEAD,	GM_PLAYER },
	{ "open_shop",	do_open_shop,		0,		POS_DEAD,	GM_PLAYER },
#endif
	{ "extend_inventory", do_extend_inventory, 0, POS_DEAD, GM_PLAYER },
#if defined(ENABLE_RENEWAL_AFFECT_SHOWER)
...
#endif
#ifdef __PERMA_ACCESSORY__
	{ "test_acc", do_test_accessory, 0,		POS_DEAD, GM_IMPLEMENTOR },
#endif
	{ "split_items", do_split_items, 0,		POS_DEAD, GM_PLAYER }, //SPLIT ITEMS
	{ "unstack_time", do_unstack_time, 0, POS_DEAD, GM_PLAYER },
#ifdef __DUNGEON_INFO__
	{ "dungeon_info",	do_dungeon_info,		0,		POS_DEAD,	GM_PLAYER },
#endif
#ifdef __SASH_SKIN__
	{ "sash_skin",	do_sash_skin,		0,		POS_DEAD,	GM_PLAYER },
#endif
#ifdef __BACK_DUNGEON__
	{ "back_dungeon",	do_back_dungeon,		0,		POS_DEAD,	GM_PLAYER },
#endif
	{ "use_item_stack", do_use_item_stack, 0, POS_DEAD, GM_PLAYER },
	{"single_bonus",  do_single_bonus_affect, 0, POS_DEAD, GM_PLAYER },
	{"multiple_buy", do_multiple_buy, 0, POS_DEAD, GM_PLAYER },
	{"sell_item", do_sell, 0, POS_DEAD, GM_PLAYER },

#ifdef _ENABLE_IPBAN_
	{ "block_account", do_ban, 0, POS_DEAD, GM_LOW_WIZARD },
	{ "ip_block_account",				do_ipban,				0,	POS_DEAD,	GM_HIGH_WIZARD	},
#endif
	...
	{ "auto_dews",		do_auto_dews,		0,		POS_DEAD, GM_PLAYER },
