...
static const std::vector<std::string> arItemType = {
	...
	"ITEM_CHEQUE",
	"ITEM_GACHA",
	"ITEM_PET", "ITEM_SOUL", // 35,36
	"ITEM_MEDIUM", "ITEM_PASSIVE", // 37,38
	"ITEM_MERCENARY", // 39
	"ITEM_BUFFI",
};
...
static const std::unordered_map<uint32_t, std::vector<std::string>> mapItemSubType {
	...
	{2,		{ "ARMOR_BODY", "ARMOR_HEAD", "ARMOR_SHIELD", "ARMOR_WRIST", "ARMOR_FOOTS",
			"ARMOR_NECK", "ARMOR_EAR", "ARMOR_PENDANT", "ARMOR_GLOVE", 
#ifdef __PENDANT__
			"ARMOR_PENDANT_FIRE",
			"ARMOR_PENDANT_ICE",
	...
	{28,	{ "COSTUME_BODY", "COSTUME_HAIR", "COSTUME_MOUNT", "COSTUME_ACCE", "COSTUME_WEAPON","COSTUME_PET","COSTUME_ACCE_SKIN","COSTUME_MOUNT_SKIN","COSTUME_NORMAL_PET_SKIN"}},
	{29,	{ "DS_SLOT1", "DS_SLOT2", "DS_SLOT3", "DS_SLOT4", "DS_SLOT5", "DS_SLOT6"}},
	{31,	{ "EXTRACT_DRAGON_SOUL", "EXTRACT_DRAGON_HEART"}},
	{37,	{ "PET_LEVELABLE","PET_EGG","PET_TRANSPORTBOX","PET_PROTEIN","PET_CHANGE_NAME_ITEM","PET_DEW",
			"PET_SKILL","PET_PRIMIUM_FEEDSTUFF","PET_ATTR_CHANGE","PET_ATTR_DETERMINE","PET_EXPFOOD_PER",
			"PET_SKILL_DEL_BOOK","PET_SKILL_ALL_DEL_BOOK","PET_EXPFOOD","PET_FEEDSTUFF"}},
	{42,	{ "BUFFI_SCROLL", "BUFFI_NAME_SCROLL"}},
};
...
int get_Item_Flag_Value(string inputString)
{
	...
	string arFlag[] = {"ITEM_TUNABLE", "ITEM_SAVE", "ITEM_STACKABLE", "COUNT_PER_1GOLD", "ITEM_SLOW_QUERY", "ITEM_UNIQUE",
			...
			"QUEST_GIVE", "LOG", "ITEM_APPLICABLE"
...
int get_Item_WearFlag_Value(string inputString)
{
	...
	string arWearrFlag[] = { "WEAR_BODY", "WEAR_HEAD", "WEAR_FOOTS", 
					"WEAR_WRIST", "WEAR_WEAPON", "WEAR_NECK", "WEAR_EAR", "WEAR_UNIQUE",
					"WEAR_ARROW", "WEAR_SHIELD", "WEAR_ABILITY", 
					"WEAR_BUFFI_RING_0","WEAR_BUFFI_RING_1","WEAR_BUFFI_RING_2",
					"WEAR_HAIR", "WEAR_PENDANT","WEAR_GLOVE",
...
int get_Item_ApplyType_Value(string inputString)
{
	...
	string arApplyType[] = {"APPLY_NONE", "APPLY_MAX_HP", "APPLY_MAX_SP", "APPLY_CON", "APPLY_INT", "APPLY_STR", "APPLY_DEX", "APPLY_ATT_SPEED",
			...
			"APPLY_ATTBONUS_BOSS","APPLY_RESIST_MONSTER","APPLY_RESIST_BOSS",
			"APPLY_CRITICAL_DAMAGE_PVM","APPLY_RESIST_RACES","APPLY_ATTBONUS_STONE","APPLY_ATTBONUS_DUNGEON"
#endif
	};
...
int get_Mob_Type_Value(string inputString)
{
	...
	if (_IsNumericString(inputString))
		return std::stoi(inputString);
#endif
	string arType[] = { "MONSTER", "NPC", "STONE", "WARP", "DOOR", "BUILDING", "PC", "POLYMORPH_PC", "HORSE", "PET", "GOTO"};
